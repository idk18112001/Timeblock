      ...
      <div className="w-1/2 flex items-center justify-center p-8">
        <div className="glass-card rounded-3xl p-12 max-w-lg w-full text-center shadow-2xl">
          ...
          <Button
            ...
            className="w-full py-4 px-6 rounded-xl mb-4 flex items-center justify-center gap-3 bg-white/10 hover:bg-white/20 transition-all text-white border border-white/20 hover:border-white/30"
            variant="outline"
          ...
          >
            ...
            <span className="font-apercu font-medium text-white">Sign up with Google</span>
          </Button>
